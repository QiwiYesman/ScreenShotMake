...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QRect(10, 20, 622, 191))
        ...
        self.define_method_input = QComboBox(self.verticalLayoutWidget)
        self.define_method_input.addItem("")
        self.define_method_input.addItem("")
        self.define_method_input.setObjectName(u"define_method_input")

        self.horizontalLayout_8.addWidget(self.define_method_input)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(QCoreApplication.translate("Form", u"Define method", None))
        self.define_method_input.setItemText(0, QCoreApplication.translate("Form", u"Key", None))
        self.define_method_input.setItemText(1, QCoreApplication.translate("Form", u"Mouse", None))
        ...
        self.backend_input.setItemText(2, QCoreApplication.translate("Form", u"printscreen", None))
        self.backend_input.setItemText(3, QCoreApplication.translate("Form", u"scrot", None))
        self.backend_input.setItemText(4, QCoreApplication.translate("Form", u"gnome-screenshot", None))
