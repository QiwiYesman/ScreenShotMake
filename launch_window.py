...
class LaunchWindow(QWidget):
    ...
    def load_default_value(self, struct: DefaultStruct):
        ...
        self.ui.define_method_input.setCurrentText(struct.default_define_method)
    ...
    def get_struct(self):
        return DefaultStruct(
            ...
            default_define_method=self.ui.define_method_input.currentText()
        )
    ...
    def launch_button_click(self):
        self.processor = HotKeyProcessor(self,
                                         ...
                                         self.get_struct())
        self.processor.setWindowFlags(self.processor.windowFlags() | Qt.Dialog)
        self.processor.show()
