...
class SettingsWindowUi(object):
    def setupUi(self, Form):
        ...
        self.main_grid_layout.addWidget(self.label_18, 6, 0, 1, 1)

        self.define_method_label = QLabel(self.gridLayoutWidget)
        self.define_method_label.setObjectName(u"define_method_label")

        self.main_grid_layout.addWidget(self.define_method_label, 6, 1, 1, 1)

        self.define_method_switch = QPushButton(self.gridLayoutWidget)
        self.define_method_switch.setObjectName(u"define_method_switch")
        self.define_method_switch.setMaximumSize(QSize(85, 16777215))

        self.main_grid_layout.addWidget(self.define_method_switch, 6, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.backend_choice.setItemText(1, QCoreApplication.translate("Form", u"printscreen", None))
        self.backend_choice.setItemText(2, QCoreApplication.translate("Form", u"pil", None))
        self.backend_choice.setItemText(3, QCoreApplication.translate("Form", u"scrot", None))
        self.backend_choice.setItemText(4, QCoreApplication.translate("Form", u"gnome-screenshot", None))

        self.label_18.setText(QCoreApplication.translate("Form", u"Define method", None))
        self.define_method_label.setText(QCoreApplication.translate("Form", u"Key", None))
        self.define_method_switch.setText(QCoreApplication.translate("Form", u"Switch", None))
