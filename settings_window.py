...
class SettingsWindow(QWidget):
    ...
    def get_struct(self):
        return DefaultStruct(
            ...
            default_define_method=self.ui.define_method_label.text()
        )
    ...
    def switch_define_method(self):
        if self.ui.define_method_label.text() == "Key":
            self.ui.define_method_label.setText("Mouse")
        elif self.ui.define_method_label.text() == "Mouse":
            self.ui.define_method_label.setText("Key")
    ...
    def set_connections(self):
        ...
        self.ui.define_method_switch.clicked.connect(self.switch_define_method)
